...
export function PageVerificationBadge({
  ...
  // CCC: HIDE the verification affordance entirely when unavailable (was a greyed
  // shield button with an "Available with a paid license" tooltip on every page
  // header). Internal tool — don't advertise unbuyable features.
...
export function PageVerificationMenuItem({
  ...
  // CCC: HIDE the menu item entirely when unavailable (was disabled + upgrade
  // tooltip). Internal tool — don't advertise unbuyable features.
  if (!hasVerificationFeature) return null;
