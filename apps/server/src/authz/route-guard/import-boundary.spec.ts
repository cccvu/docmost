...
const SEAM_ALLOWLIST = new Set<string>([
  ...
  'app.module.ts', // seam #4 — CollabDisconnectModule + ConditionalPageModule + PlatformAuditModule + PlatformAuthorizationGuard + PublicSurfaceThrottlerGuard (#29) + ResponseHeadersModule
